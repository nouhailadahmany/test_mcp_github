# Table: `STAGING.STG_CAMPAIGN_METRICS_RAW`
...
Raw landing table; many numeric fields stored as TEXT; includes `RAW_JSON` and ingestion/process columns.
